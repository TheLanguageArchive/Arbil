...
//    public abstract String[] loadStringArray(String filename) throws IOException;
//    public abstract void saveStringArray(String filename, String[] storableValue) throws IOException;
    public abstract String loadString(String filename);

    public abstract void saveString(String filename, String storableValue);
