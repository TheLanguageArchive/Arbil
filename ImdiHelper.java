...
public class ImdiHelper {
    ...
    public DefaultMutableTreeNode getImdiTreeNode(OurURL inUrlLocal) {
        ...
        if (!inURL.getFile().endsWith(".imdi")) {
            ImdiTreeNode imdiTreeNode = new ImdiTreeNode(inUrlLocal.getPath(), null, inUrlLocal.getPath());
            ...
            if (dom == null) {
                ...
                ImdiTreeNode imdiTreeNode = new ImdiTreeNode(nodeName, dom, inUrlLocal.getPath());
                treeNode = new DefaultMutableTreeNode(imdiTreeNode);
            }
        }
        return treeNode;
    ...
    public void addToGridData(DefaultTableModel tableModel, DefaultMutableTreeNode itemNode) {
