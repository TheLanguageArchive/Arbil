...
//            System.out.println("save locationsList exception: " + ex.getMessage());
	...
	try {
	    locationsArray = sessionStorage.loadStringArray("locationsList");
	...
	if (locationsArray == null) {
		...
		if (currentLocation == null) {
			...
			if (currentTreeObject.isLocal()) {
			    ...
			    } else if (sessionStorage.pathIsInsideCache(currentTreeObject.getFile())) {
	...
	showHiddenFilesInTree = sessionStorage.loadBoolean("showHiddenFilesInTree", showHiddenFilesInTree);
    }
	...
	try {
	    sessionStorage.saveBoolean("showHiddenFilesInTree", showHiddenFilesInTree);
	} catch (Exception ex) {
