...
AppId={{9B1B10AE-06A3-11DF-3D81-000C29E71C44}
AppName=Arbil
AppVerName=Arbil-1-2-x
AppPublisher=The Technical Group (TG) of Max Planck Institute for Psycholinguistics
AppPublisherURL=http://www.lat-mpi.eu/tools/arbil
AppSupportURL=http://www.lat-mpi.eu/tools/arbil
AppUpdatesURL=http://www.lat-mpi.eu/tools/arbil
DefaultDirName={pf}\Arbil
DefaultGroupName=Language archiving tools (LAT) 
OutputDir=C:\windows\profiles\petwit\Desktop\arbil-build-1.2.x\distribution-win32
OutputBaseFilename=arbil-setup
Compression=lzma
