        ...
        return new Thread(threadName) {
            ...
            public void run() {
                ...
                directoryForSizeTest = exportDestinationDirectory != null
                        ...
                        : LinorgSessionStorage.getSingleInstance().getCacheDirectory();
            ...
            private void copyElement(Object currentElement, ArrayList<URI> getList, Hashtable<URI, RetrievableFile> seenFiles, ArrayList<URI> doneList, XsdChecker xsdChecker, ArrayList<ImdiTreeObject> finishedTopNodes) {
...
///////////////////////////////////////////
    ...
    private class RetrievableFile {
        ...
        public void calculateTreeFileName(boolean lamusFriendly) {
            ...
            ImdiTreeObject currentNode = ImdiLoader.getSingleInstance().getImdiObject(null, sourceURI);
