...
//        System.out.println("LinorgFavourites getSingleInstance");
    ...
    public void convertOldFormatLocationListsX() {
        try {
            File oldLocationsFile = new File(ArbilSessionStorage.getSingleInstance().storageDirectory, "locationsList");
            File oldFavouritesFile = new File(ArbilSessionStorage.getSingleInstance().storageDirectory, "selectedFavourites");
            if (oldLocationsFile.exists()) {
                Vector<String> locationsList = (Vector<String>) ArbilSessionStorage.getSingleInstance().loadObject("locationsList");
                if (oldFavouritesFile.exists()) {
                    Vector<String> userFavouritesStrings = (Vector<String>) ArbilSessionStorage.getSingleInstance().loadObject("selectedFavourites");
                ...
                if (null == ArbilSessionStorage.getSingleInstance().loadStringArray("locationsList")) {
                    ArbilSessionStorage.getSingleInstance().saveStringArray("locationsList", locationsList.toArray(new String[]{}));
                }
            }
        } catch (Exception ex) {
