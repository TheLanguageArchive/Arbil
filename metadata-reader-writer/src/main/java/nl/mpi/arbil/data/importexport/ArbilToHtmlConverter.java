...
public class ArbilToHtmlConverter {
	...
	try {
	    transformer.transform(new javax.xml.transform.stream.StreamSource(inputNode.getRedirectedUri().toString()), new javax.xml.transform.stream.StreamResult(new java.io.FileOutputStream(destinationFile.getCanonicalPath())));
