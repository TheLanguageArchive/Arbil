...
public class ImdiMetadataBuilderTest {
    ...
    private static ArbilDesktopInjector injector;
	...
	injector = new ArbilDesktopInjector();
	...
	ImdiMetadataBuilder metadataBuilder = new ImdiMetadataBuilder(injector.getWindowManager(), injector.getWindowManager(), new MockSessionStorage(), injector.getTreeHelper(), injector.getDataNodeLoader(), new ApplicationVersionManager(new ArbilVersion()));
