...
//            System.out.println("save locationsList exception: " + ex.getMessage());
    ...
    /**
     * Requests to add a new node of given type to root of the tree
     *
	...
	ArbilDataNode arbilDataNode = dataNodeLoader.createNewDataNode(getSessionStorage().getNewArbilFileName(getSessionStorage().getSaveLocation(""), nodeType));
	arbilDataNode.getDataNodeService().getMetadataBuilder().requestAddNode(arbilDataNode, nodeType, nodeTypeDisplayName);
    }
