...
//        }
    ...
    private Properties getConfig() {
        ...
        try {
            propertiesInStream = new FileInputStream(new File(getApplicationSettingsDirectory(), "arbil.config"));
            propertiesObject.load(propertiesInStream);
        } catch (IOException ioe) {
            // file not found so create the file
    ...
    private void saveConfig(Properties configObject) {
        ...
        try {
            ...
            propertiesOutputStream = new FileOutputStream(new File(getApplicationSettingsDirectory(), "arbil.config"));
