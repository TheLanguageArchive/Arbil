...
public interface SessionStorage extends PluginSessionStorage {
     ...
     * download failed
     */
    boolean saveRemoteResource(URL targetUrl, File destinationFile, boolean expireCacheCopy, boolean followRedirect, DownloadAbortFlag abortFlag, JLabel progressLabel);
     ...
     * @return The path of the file in the cache.
     */
    File updateCache(String pathString, boolean expireCacheCopy, boolean followRedirect, DownloadAbortFlag abortFlag, JLabel progressLabel);
