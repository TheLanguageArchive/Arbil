...
//        });
    ...
    private void initPluginMenu() {
        this.add(new PluginMenu(PluginService.getInstance(), new ArbilPluginManager(ArbilSessionStorage.getSingleInstance(), ArbilWindowManager.getSingleInstance(), ArbilDataNodeLoader.getSingleInstance(), new ArbilBugCatcher()), true));
    }
