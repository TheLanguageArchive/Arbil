...
public class ArbilTableModel extends AbstractArbilTableModel implements ClipboardOwner {
	...
	try {
	    ...
	    embadTagStringBuilder.append(
		    ...
		    + "lib/corpusstructure-api-1.8.8.jar,"
		    + "lib/corpus-structure-2-core-1.1.6.jar,"
		    + "lib/metadata-translator-1.5.3.jar,"
		    + "lib/handle-6.1.jar,"
		    + "lib/commons-io-1.4.jar,"
		    + "lib/plugins-core-1.2.87-stable.jar,"
		    + "lib/arbil-commons-2.6.45-testing.jar,"
		    + "lib/arbil-localisation-2.6.153-testing.jar"
		    + "\"\n");
