...
/**
 * Document : JListToolTip Created on :
 *
...
//     TODO: fix the tool tip text box bounding size //   jPanel.invalidate();
    ...
    private void addLabelsForDataNode(ArbilDataNode tempObject) {
        if (tempObject.isMetaDataNode()) {
            ...
            if (!tempObject.getUri().equals(tempObject.getRedirectedUri())) {
                addDetailLabel("Redirected location: " + tempObject.getRedirectedUri().toString());
            }
