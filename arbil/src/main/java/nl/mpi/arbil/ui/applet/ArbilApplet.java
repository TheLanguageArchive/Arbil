...
public class ArbilApplet extends javax.swing.JApplet {
	...
	try {
		...
		public void run() {
		    ...
		    ArbilMenuBar arbilMenuBar = new ArbilMenuBar(new ArbilConfiguration(), previewSplitPanel, ArbilApplet.this, new ArbilLogConfigurer(new ArbilVersion(), "arbil-applet-log"));
